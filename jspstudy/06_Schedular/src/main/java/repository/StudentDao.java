...
public class StudentDao {
	...
	// 9. 학생상세보기
	public Student selectStudentsByNO(int stuNo) {//int styNo=파라미터
		SqlSession ss = factory.openSession();
		Student student = ss.selectOne(mapper + "selectStudentsByNO", stuNo);
		ss.close();
		return student;
		
	}
	// 10. 학생 수정
	public int updateStudent(Student student) {//int styNo=파라미터
		SqlSession ss = factory.openSession(false);
