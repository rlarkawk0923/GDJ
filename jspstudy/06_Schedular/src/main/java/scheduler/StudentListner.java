...
/**
	...
	1. 웹 애플리케이션(프로젝트)의 LifeCycle을 가진다.(웹 애플리케이션과 함께)
	2. contextInitialized() : 웹 애플리케이션 시작할 때 동작
	3. contextDestroyed() : 웹 애플리케이션 종료할 때 동작
 */
@WebListener // 나는 리스너다

public class StudentListner implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent arg0)  { 
    	...
    	/*
    	  Cron Expression(크론식) - www.cronMaker.com 참고할것
    	  1. 구성
    	  	초 분 시 일 월 요일 [년도]
    	  2. 상세
	    	  1) 초 : 0 ~ 59
