...
@WebServlet("/my") // @WebServlet({"/my", "/me"}) 처럼 2개의 URL Mapping을 지정할 수 잇음
public class MyServlet extends HttpServlet {
	...
	out.println("<title>");
	out.println("나의 첫번째 응답");
	out.println("</title>");
	out.println("</head>");
	out.println("<h1>안녕하세요." + name + "님 반갑슴니다</h1>");
	if(age >= 20) {
		out.println("<h1>귀하는 "+ age + "살이므로 입장이 가능합니다.</hr>");
	}else {
		out.println("<h1>귀하는 "+ age + "살이므로 입장이 불가능합니다.</hr>");		
	}
    out.println("</body>");
    out.println("</html>");
