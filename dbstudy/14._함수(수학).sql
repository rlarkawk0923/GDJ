...
-- 8. 원하는 자리수로 절사
--    TRUNC(A, [DIGIT]) : 실수 A를 DIGIT 자릿수로 절사, DIGIT 생략하면 정수로 절사 []-생략할 수 있음
SELECT
      TRUNC(1.9999)     --1
    , TRUNC(1.9999, 1)  --1.9
    , TRUNC(1.9999, 2)  --1.99
...
-- 8. 원하는 자리수로 반올림
--    ROUND(A, [DIGIT]) : 실수 A를 DIGIT 자릿수로 반올림, DIGIT 생략하면 정수로 반올림 []-생략할 수 있음
...
SELECT
      ...
      , CEIL(1111 * POWER(10 ,-1)) / POWER(10, -1) -- 11120
      , CEIL(1111 * POWER(10 ,-2)) / POWER(10, -2) -- 11200
FROM
     DUAL;
