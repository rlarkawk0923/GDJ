...
public class SecurityUtil {
	...
	public String sha256(String str) {
		...
		byte[] b = md.digest(); // 배열 b : 문자열 str이 암호화 된 32바이트 크기의 배열 16진수값 2개로 바꿔서 표현하겠다
	...
	// 인증코드 만들기
	// 1. 보안을 위해서 Math.random(),( Random 클래스 ) 사용을 지양한다.
