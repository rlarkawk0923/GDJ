...
<div>
	...
	<div>
		<span>▷ 작성일 <fmt:formatDate value="${blog.createDate}"
				pattern="yyyy. M. d HH:mm" /></span> &nbsp;&nbsp;&nbsp; <span>▷ 수정일
			<fmt:formatDate value="${blog.modifyDate}" pattern="yyyy. M. d HH:mm" />
		</span>
	</div>
	...
	function fn_addComment(){
				...
				success: function(resData){
					...
					*/
					...
					$.each(resData.commentList, function(i, comment){
						...
						$('#comment_list').append('<div stlye="border-bottom: 1px dotted gray;"></div>');
					});
					// 페이징
					$('#paging').empty();
		...
		function fn_changePage(){
			//$(만들어져있던 부모).on('click', '.enable_link', function(){
