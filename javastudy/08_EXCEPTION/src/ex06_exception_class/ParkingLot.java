...
public class ParkingLot {
	...
	public void addCar() throws MyException { //소속이 Runtimeex~가 아니라서 throws 생략 불가능
		if(idx == 0){//cars.length) {
			throw new MyException("FULL", 1000);
		}
	}
	
	public void deleteCar() throws MyException { //소속이 Runtimeex~가 아니라서 throws 생략 불가능
		if(idx == 0) {
