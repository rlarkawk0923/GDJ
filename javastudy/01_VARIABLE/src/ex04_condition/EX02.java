...
public class EX02 {
	...
	public static void main(String[] args) {
		...
		// 논리 연산자
		// 논리 AND : &&, 모두 true 이면 true, 하나라도 false이면 false
		// 논리 OR : ||, 하나라도 true 이면 true/모두 false이면 false
		...
		//논리 AND : false가 발생하면 더 이상 진행하지 않는다. 최종결과는 false이므로
		...
		System.out.println(j); //11이 아니라 10, false 발생하여 연산 진행하지않음
